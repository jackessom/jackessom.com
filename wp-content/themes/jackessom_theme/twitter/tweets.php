<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		// Function parameters.
		$twitter_user_id,
		$cache_file          = 'wp-content/themes/jackessom_theme/twitter/tweets.txt',  // Change this to the path of your cache file. (Default : ./tweets.txt)
		...
		$twitter_wrap_open   = '<div class="home-tweets-ul">',
		$twitter_wrap_close  = '</div>',
		$tweet_wrap_open     = '<div><p class="home-tweet-tweet">',
		$meta_wrap_open      = '<br/><span class="home-tweet-date">',
		$meta_wrap_close     = '</span>',
		$tweet_wrap_close    = '</p></div>',
		$date_format         = 'M d',    // Date formatting. (http://php.net/manual/en/function.date.php)
		...
		$consumerkey         = "PCf03xogAXFxYEOTiefQOLevk";
		$consumersecret      = "RWRHbL8kIUtgk602cwX0LMefMD1f0ujuw36jzHOy1txF9t9V8z";
		$accesstoken         = "245133329-dfpzs7Kq3KTlvqQlz5sKSpQfY4gQ8lCm44JqT85i";
		$accesstokensecret   = "5HuNDTp232JdGDrsZ9yILhryaaoArLxGzwZalEUFhZdPv";
		...
		$connection = getConnectionWithAccessToken($consumerkey, $consumersecret, $accesstoken, $accesstokensecret);
			...
			if($connection){
              ...
              $tweet_desc = str_replace($entities->urls[0]->url, $entities->urls[0]->expanded_url, $tweet_desc);
							...
							// Render the tweet.
							$twitter_html .= /*$tweet_wrap_open.*/html_entity_decode($tweet_desc)./*$meta_wrap_open.*/' '.'<a class="tweet-time" href="http://twitter.com/'.$twitter_user_id.'">'.$display_time.'</a>'/*.$meta_wrap_close.$tweet_wrap_close*/;
